...
export function ArticleLayout({
  ...
  return (
    <>
      <Head>
        <title>{`${meta.title} - C. Todd Lombardo`}</title>
          ...
          <div className="mx-auto max-w-2xl">
            ...
            <article>
              <header className="flex flex-col">
                <h1 className="mt-6 text-4xl font-bold tracking-tight text-slate-800 dark:text-slate-100 sm:text-5xl" style="font-family: Gilroy">
                  {meta.title}
                </h1>
                <time
                  dateTime={meta.date}
