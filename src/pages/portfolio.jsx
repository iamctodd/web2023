...
import logoTedx from '@/images/logos/ted.svg'
...
const projects = [
  {
    ...
    link: { href: 'https://superfuel.ai', label: 'superfuel.ai' },
    logo: logoAnimaginary
  },
  {
    name: 'dooDrops',
    description:
      'Poop tracking for your pup. Never wonder if Fido did his business.',
    link: { href: 'https://doodrops.com', label: 'doodrop.com' },
    logo: logoAnimaginary,
  },
  {
    name: 'TEDx',
...
export default function Projects() {
  return (
    <>
      <Head>
        <title>Portfolio - C Todd Lombardo</title>
        <meta
          name="description"
